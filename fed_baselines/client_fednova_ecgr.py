...
class FedNovaECGRClient(FedClient):
    ...
    def train(self):
        ...
        final_grad = {}
        for name in selected_grads[0]:
            final_grad[name] = combined_sum[name] / (coeff * ratio)

        return self.model.state_dict(), self.n_data, loss.data.cpu().numpy(), coeff, final_grad